	...
	\begin{figure}[hbt!]
		...
		\begin{minipage}{0.45\textwidth}
			...
			\begin{tikzpicture}
				...
				\end{axis}
			\end{tikzpicture}
			\subcaption{Facilidad del proceso de monitoreo.}
		...
		\begin{minipage}{0.45\textwidth}
			...
			\begin{tikzpicture}
				...
				\end{axis}
			\end{tikzpicture}
			\subcaption{Frecuencia de monitoreo.}
		...
		\end{minipage}
		\caption{Resultados de preguntas realizadas a los padres sobre el proceso de monitoreo de sus hijos de primaria mientras hacen sus tareas.}
		...
		\begin{minipage}{0.45\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					...
					height=6.1cm,
					width=0.9\textwidth,
					symbolic x coords={Monitoreo, Diseño agradable},
					xtick=data,
					ylabel={Cantidad},
					ymin=0,
					nodes near coords,
					...
					\addplot coordinates {(Monitoreo, 7) (Diseño agradable, 5)};
				\end{axis}
			\end{tikzpicture}
